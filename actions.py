...
class Formulario_Pedido(FormAction):
    ...
    def required_slots(tracker):
        if tracker.get_slot("hacer_modificaciones")==True:
            return["promocion_elegida", "hacer_modificaciones", "modificaciones", "entrega_producto", "numero_telefono", "agregar_salsas", "palitos", "metodo_pago"]
        else:
            return["promocion_elegida", "hacer_modificaciones", "entrega_producto", "numero_telefono", "agregar_salsas", "palitos", "metodo_pago"]
